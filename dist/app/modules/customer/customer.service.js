...
const insertIntoDb = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.customerRequest.create({
        data: payload,
    });
    return result;
});
...
const getAllFrom = (options, filters) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (searchTerm) {
        andConditions.push({
            OR: customer_constant_1.CUSTOMER_REQUEST_SEARCH_FIELDS.map(field => {
                if (field !== 'status') {
                    return {
                        [field]: {
                            contains: searchTerm,
    ...
    const result = yield prisma_1.default.customerRequest.findMany({
        // filters
    ...
    const total = yield prisma_1.default.customerRequest.count({ where: whereConditions });
    return {
        meta: {
            total,
            page,
...
const getSingleItem = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.customerRequest.findUnique({
        where: {
            id,
        },
    });
...
const updateIntoDb = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.customerRequest.update({
        where: {
            id,
        },
        data: payload,
...
const deleteFromDb = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.customerRequest.delete({
        where: {
            id,
        },
    });
