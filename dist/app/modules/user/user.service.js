...
// get all user
const getAllUsers = (options, filters) =>
  __awaiter(void 0, void 0, void 0, function* () {
    // paginatin
    ...
    const passwordRemoved = result.map(item =>
      (0, utils_1.excludeFields)(item, ['password'])
    );
...
const deleteSingleUser = id =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (
      (wantToDeleteUser === null || wantToDeleteUser === void 0
        ? void 0
        : wantToDeleteUser.role) === client_1.USER_ROLE.super_admin
    ) {
      throw new ApiError_1.default(
        http_status_1.default.FORBIDDEN,
        'Can not delete super admin!'
      );
    }
