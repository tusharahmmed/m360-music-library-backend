...
const signin = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // create token
    const accessToken = jwtHelpers_1.jwtHelpers.createToken({ id: user.id, role: user.role, permissions: user.permissions }, config_1.default.jwt.secret, config_1.default.jwt.expires_in);
    const refreshToken = jwtHelpers_1.jwtHelpers.createToken({ id: user.id, role: user.role, permissions: user.permissions }, config_1.default.jwt.refresh_secret, config_1.default.jwt.refresh_expires_in);
