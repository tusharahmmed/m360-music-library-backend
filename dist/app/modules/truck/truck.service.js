...
const insertIntoDb = (payload, file) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield prisma_1.default.truck.create({
        data: payload,
    });
    return result;
});
const getAllFromDb = (options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield prisma_1.default.truck.findMany({
        // pagination
        orderBy: {
            [sortBy]: sortOrder,
        },
    ...
    const total = yield prisma_1.default.truck.count();
    return {
        meta: {
            page,
            limit,
...
const getSingeFromDb = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.truck.findUnique({
        where: {
            id,
        },
    });
...
const updateIntoDb = (id, payload, file) => __awaiter(void 0, void 0, void 0, function* () {
    const existingTruck = yield prisma_1.default.truck.findUnique({
        where: {
            id,
        },
    });
    // if has file
    if (file && !(existingTruck === null || existingTruck === void 0 ? void 0 : existingTruck.image)) {
        const uploadedImage = yield FileUploadHelper_1.FileUploadHelper.uploadToCloudinary(file);
        if (!uploadedImage) {
            throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, 'Image upload failed');
        }
    ...
    if (file && (existingTruck === null || existingTruck === void 0 ? void 0 : existingTruck.image)) {
        const response = yield FileUploadHelper_1.FileUploadHelper.replaceImage(existingTruck.image, file);
        if (!response) {
            throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, 'Image upload failed');
        }
        payload.image = response.secure_url;
    }
    const result = yield prisma_1.default.truck.update({
        where: {
            id,
        },
        data: payload,
...
const deleteFormDb = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.truck.delete({
        where: {
            id,
        },
    });
