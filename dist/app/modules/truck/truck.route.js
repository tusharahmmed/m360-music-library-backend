...
router.patch(
  ...
  (0, formDataValidation_1.default)(
    truck_validation_1.TruckValidation.updateTruckSchema,
    truck_controller_1.TruckController.updateIntoDb
  )
);
router.delete(
  '/:id',
  ...
  truck_controller_1.TruckController.deleteFormDb
);
router.get(
  '/:id',
  (0, auth_1.default)(
  ...
  truck_controller_1.TruckController.getSingeFromDb
);
router.post(
  '/',
  (0, auth_1.default)(
  ...
  FileUploadHelper_1.FileUploadHelper.upload.single('file'),
  (0, formDataValidation_1.default)(
    truck_validation_1.TruckValidation.createTruckSchema,
    truck_controller_1.TruckController.insertIntoDb
  )
...
router.get(
  ...
  truck_controller_1.TruckController.getAllFromDb
);
